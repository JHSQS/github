...
<head>
    ...
    <link rel="stylesheet" href="/myApp/Public/Css/delialist.css" />
...
<article>
    ...
    <section id="content">
        <?php if(is_array($data)): foreach($data as $key=>$v): ?><div class="title"><p><?php echo ($v["title"]); ?></p></div>
            <hr size="4" color="#EF2F88"/>
            <div class="con_img"><img src="<?php echo ($v["pic"]); ?>" width="180px" height="180px"/></div>
            <div id="neirong">
                　　
                <?php echo ($v["content"]); ?>
            </div><?php endforeach; endif; ?>
		<hr size="3"/>
<form method="post" action="<?php echo U('Index/checkpinglun');?>">
<section id="pinglun">
<textarea rows="10" cols="50" name="pinglun" align="center"></textarea>
