...
<html>
	...
	<nav class="nav_div">
		...
		<article>
			...
			<section id="content">
			<?php if(is_array($data)): foreach($data as $key=>$v): ?><div class="title"><a href="<?php echo U('Index/delialist',array(id=>$v[id]));?>"><p><?php echo ($v["title"]); ?></p></a></div>
				<hr size="4" color="#EF2F88"/>
				<div class="con_img"><img src="<?php echo ($v["pic"]); ?>" width="280px" height="280px"/></div><?php endforeach; endif; ?>	
				
				<!-- <div class="title"><p>年少不听李宗盛，因为那都是人生......</p></div>
				<hr size="4" color="#EF2F88"/>
				<div class="con_img"><img src="/myApp/Public/Images/conf2.jpg" width="280px" height="280px"/></div> -->
			</section>
