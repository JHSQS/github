...
$objWriter->save(str_replace('.php', '.execl', __FILE__));
echo date('H:i:s') , " File written to " , str_replace('.php', '.execl', pathinfo(__FILE__, PATHINFO_BASENAME)) , EOL;

// Export to CSV with BOM (.execl)
echo date('H:i:s') , " Write to CSV format (with BOM)" , EOL;
$objWriter->setUseBOM(true);
$objWriter->save(str_replace('.php', '-bom.execl', __FILE__));
echo date('H:i:s') , " File written to " , str_replace('.php', '-bom.execl', pathinfo(__FILE__, PATHINFO_BASENAME)) , EOL;
