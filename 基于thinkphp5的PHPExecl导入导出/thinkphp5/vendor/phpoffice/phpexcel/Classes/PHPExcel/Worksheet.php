   ...
   /**
    ...
    public function addChart(PHPExcel_Chart $pChart = null, $iChartIndex = null)
    {
        ...
        if (is_null($iChartIndex)) {
            ...
            // Insert the chart at the requested home
    ...
    /**
     * Get a chart by its home position
     *
     * @param string $index Chart home position
     ...
     *
     * @param int $pRow Numeric home of the row
     * @return PHPExcel_Worksheet_RowDimension
     */
     ...
     *
     * @param string $pColumn String home of the column
     * @return PHPExcel_Worksheet_ColumnDimension
     */
