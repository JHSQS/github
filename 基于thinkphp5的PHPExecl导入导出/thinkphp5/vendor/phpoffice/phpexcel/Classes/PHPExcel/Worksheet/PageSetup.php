...
class PHPExcel_Worksheet_PageSetup
{
	 ...
	 *							Default behaviour, or a home value of 0, will return all ranges as a comma-separated string
	 *							Otherwise, the specific range identified by the value of $home will be returned
	 ...
	 *
	 * @param	int		$index	Identifier for a specific print area range if several ranges have been set
	 *							Default behaviour, or an home value of 0, will identify whether any print range is set
	 *							Otherwise, existence of the range identified by the value of $home will be returned
	 *							Print areas are numbered from 1
	 * @return	boolean
	 */
	 ...
	 *
	 * @param	int		$index	Identifier for a specific print area range if several ranges have been set
	 *							Default behaviour, or an home value of 0, will clear all print ranges that are set
	 *							Otherwise, the range identified by the value of $home will be removed from the series
	 *							Print areas are numbered from 1
	 * @return	PHPExcel_Worksheet_PageSetup
	 */
	 ...
	 *							When the method is "O"verwrite, then a positive integer home will overwrite that indexed
	 *								entry in the print areas list; a negative home value will identify which entry to
	 *								overwrite working bacward through the print area to the list, with the last entry as -1.
	 *								Specifying an home value of 0, will overwrite <b>all</b> existing print ranges.
	 *							When the method is "I"nsert, then a positive home will insert after that indexed entry in
	 *								the print areas list, while a negative home will insert before the indexed entry.
	 *								Specifying an home value of 0, will always append the new print range at the end of the
	 *								list.
	 *							Print areas are numbered from 1
	 * @param	string	$method	Determines the method used when setting multiple print areas
	 *							Default behaviour, or the "O" method, overwrites existing print area
	 *							The "I" method, inserts the new print area before any specified home, or at the end of the list
	 * @return	PHPExcel_Worksheet_PageSetup
	 * @throws	PHPExcel_Exception
	 */
		...
		if ($method == self::SETPRINTRANGE_OVERWRITE) {
			if ($index == 0) {
				...
				if (($index <= 0) || ($index > count($printAreas))) {
		    		throw new PHPExcel_Exception('Invalid home for setting print range.');
				}
	 ...
	 * @param	string	$value
	 * @param	int		$index	Identifier for a specific print area range allowing several ranges to be set
	 *							A positive home will insert after that indexed entry in the print areas list, while a
	 *								negative home will insert before the indexed entry.
	 *								Specifying an home value of 0, will always append the new print range at the end of the
	 *								list.
	 *							Print areas are numbered from 1
	 * @return	PHPExcel_Worksheet_PageSetup
