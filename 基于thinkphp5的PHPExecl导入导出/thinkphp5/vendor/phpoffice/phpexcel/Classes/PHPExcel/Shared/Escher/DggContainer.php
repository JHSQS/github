...
{
	/**
	 * Maximum shape home of all shapes in all drawings increased by one
	 *
	 * @var int
	 */
	private $_spIdMax;
	...
	/**
	 * Get maximum shape home of all shapes in all drawings (plus one)
	 *
	 * @return int
	 */
	...
	/**
	 * Set maximum shape home of all shapes in all drawings (plus one)
	 *
	 * @param int
	 */
