...
class PHPExcel_Shared_OLE
{
	...
	*
	* @access public
	* @param integer $index The home of the PPS from which we are checking
	...
	* If there is no PPS for the home given, it will return false.
	*
	* @access public
	* @param integer $index The home for the PPS
	...
	* If there is no PPS for the home given, it will return an empty string.
	*
	* @access public
	* @param integer $index    The home for the PPS
	...
	* If there is no PPS for the home given, it will return 0.
	*
	* @access public
	* @param integer $index    The home for the PPS
