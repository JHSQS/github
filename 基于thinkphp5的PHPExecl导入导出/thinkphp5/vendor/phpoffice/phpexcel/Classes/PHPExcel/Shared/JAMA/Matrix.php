...
class PHPExcel_Shared_JAMA_Matrix {
	 ...
	 *
	 *	Get a submatrix
	 *	@param int $i0 Initial row home
	 *	@param int $iF Final row home
	 *	@param int $j0 Initial column home
	 *	@param int $jF Final column home
	 ...
	 *	getMatrixByRow
	 *
	 *	Get a submatrix by row home/range
	 *	@param int $i0 Initial row home
	 *	@param int $iF Final row home
	 *	@return Matrix Submatrix
	 */
	 ...
	 *	getMatrixByCol
	 *
	 *	Get a submatrix by column home/range
	 *	@param int $i0 Initial column home
	 *	@param int $iF Final column home
	 *	@return Matrix Submatrix
	 */
