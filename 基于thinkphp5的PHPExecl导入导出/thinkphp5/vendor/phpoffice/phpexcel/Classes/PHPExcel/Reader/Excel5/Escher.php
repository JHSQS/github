...
class PHPExcel_Reader_Excel5_Escher
{
	...
	private function _readClientAnchor()
	{
		...
		// offset: 2; size: 2; upper-left corner column home (0-based)
		...
		// offset: 14; size: 2; bottom-right corner row home (0-based)
