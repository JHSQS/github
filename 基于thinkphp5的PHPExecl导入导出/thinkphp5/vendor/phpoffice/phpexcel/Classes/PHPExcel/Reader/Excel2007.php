...
//				echo 'Adjusted Formula is ', $value, PHP_EOL;
	...
	//									echo 'Value is ', $value, PHP_EOL;
										...
										if ($c["s"] && !$this->_readDataOnly) {
											// no style home means 0, it seems
					...
					if ((!$this->_readDataOnly) || (!empty($this->_loadSheetsOnly))) {
						// active sheet home
						$activeTab = intval($xmlWorkbook->bookViews->workbookView["activeTab"]); // refers to old sheet home

						// keep active sheet home if sheet is still loaded, else first sheet is set as the active
