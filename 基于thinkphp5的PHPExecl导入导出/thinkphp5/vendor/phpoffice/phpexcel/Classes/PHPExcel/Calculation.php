...
class PHPExcel_Calculation {
	...
	/**
	 * Read the dimensions of a matrix, and re-home it with straight numeric keys starting from row 0, column 0
	 *
	...
	private function _parseFormula($formula, PHPExcel_Cell $pCell = NULL) {
		...
		while(TRUE) {
//echo 'Assessing Expression '.substr($formula, $home),PHP_EOL;
			$opCharacter = $formula{$index};	//	Get the first character of the value at the current home position
