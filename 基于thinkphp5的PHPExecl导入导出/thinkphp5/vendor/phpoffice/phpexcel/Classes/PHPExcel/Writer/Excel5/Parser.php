...
class PHPExcel_Writer_Excel5_Parser
{
	...
	/**
	 * The home of the character we are currently looking at
	 * @var integer
	 */
...
//		}
	 ...
	 * @return	string				The reference home in packed() format
	 */
	...
	/**
	 * Look up the REF home that corresponds to an external sheet name
	 * (or range). If it doesn't exist yet add it to the workbook's references
	 * array. It assumes all sheet names given must exist.
	 *
	 * @access private
	 * @param string $ext_ref The name of the external reference
	 * @return mixed The reference home in packed() format on success
	 */
	...
	/**
	 * Look up the home that corresponds to an external sheet name. The hash of
	 * sheet names is updated by the addworksheet() method of the
	 * PHPExcel_Writer_Excel5_Workbook class.
	 *
	 * @access	private
	 * @param	string	$sheet_name		Sheet name
	 * @return	integer					The sheet home, -1 if the sheet was not found
	 */
	 ...
	 * @param integer $index The home of the worksheet being added
	 */
