...
class PHPExcel_Writer_Excel5_Workbook extends PHPExcel_Writer_Excel5_BIFFwriter
{
	...
	/**
	 * Added fonts. Maps from font's hash => home in workbook
	 *
	 * @var array
	 */
	...
	/**
	 * Added number formats. Maps from numberFormat's hash => home in workbook
	 *
	 * @var array
	 */
	...
	public function addXfWriter($style, $isStyleXf = false)
	{
		...
		// Assign the font home to the xf record
		...
		// Assign the number format home to xf record
	 ...
	 * @param	string		$sheetIndex		1-based sheet home the defined name applies to. 0 = global
	 ...
	 * @param integer $ifmt   Format home code
	 */
	 ...
	 *
	 * @param integer $index  Sheet home
