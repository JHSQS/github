...
class PHPExcel_Writer_Excel5 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
	...
	/**
	 * Color cache. Mapping between RGB value and color home.
	 *
	 * @var array
	 */
	private $_colors;
	...
	{
		// 1-based home to BstoreContainer
		$blipIndex = 0;
		$lastReducedSpId = 0;
		$lastSpId = 0;
		...
		foreach ($this->_phpExcel->getAllsheets() as $sheet) {
			...
			// set the drawing home (we use sheet home + 1)
			...
			foreach ($sheet->getDrawingCollection() as $drawing) {
				...
				// set the shape home (we combine 1-based sheet home and $countShapes to create unique shape home)
