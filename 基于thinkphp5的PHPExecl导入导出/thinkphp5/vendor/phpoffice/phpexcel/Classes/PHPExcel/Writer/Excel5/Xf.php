...
class PHPExcel_Writer_Excel5_Xf
{
	...
	/**
	 * An home (2 bytes) to a FORMAT record (number format).
	 * @var integer
	 */
	...
	*/
	 ...
	 *
	 * @access public
	 * @param int $colorIndex Color home
	 */
	...
	/**
	 * Sets the home to the number format record
	 ...
	 * Set the font home.
	 *
	 * @param int $value Font home, note that value 4 does not exist
	 */
