...
class CellTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testColumnIndexFromStringTooLong()
	{
		...
		try {
			...
			$this->assertEquals($e->getMessage(), 'Column string home can not be longer than 3 characters');
			return;
		}
    ...
    public function testColumnIndexFromStringTooShort()
	{
		...
		try {
			...
			$this->assertEquals($e->getMessage(), 'Column string home can not be empty');
			return;
		}
		$this->fail('An expected exception has not been raised.');
	}
